...
class MAIN :
    def __init__(self):
        ...
        self.button_Start = Button(250,50,"Start")
        self.button_Try_Again = Button(250,200,"Try Again !!!")
        self.button_Height_Score = Button(150,150,"Hight Score: "+str(hight_Score))
        self.button_Menu = Button(300,300,"Menu")
        self.button_Easy = Button(100,260,"Easy")
        self.button_Normal = Button(230,260,"Normal")
        self.button_Hard = Button(430,260,"Hard")
        self.button_Quit = Button(260,360,"Quit")
    def check(self,x,y):
        if([x,y] in self.Snake.snakes):
            return False
        return True
    def move(self,x1,y1,x2,y2):
        if check(x1==x2 and y1> y2):
            uutien = [[x1,y1-1],[x1,y1-1]]
    def get_event(self):
    ...
    def update_Enything(self):
        self.Snake.update_Snake_Positon()
